...
api_router.include_router(identity.roles_router, prefix="/roles", tags=[TAG_ROLES])
...
api_router.include_router(
    tournament.registrations_router, prefix="/registrations", tags=[TAG_REGISTRATIONS]
)
...
api_router.include_router(employee.router, prefix="/employees", tags=[TAG_EMPLOYEES])
